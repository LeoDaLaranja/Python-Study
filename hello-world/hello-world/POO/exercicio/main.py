#TODO
'''
Criar a verificação para contas bradesco, mostrar o saldo depois de concluido e o valor da transferencia 
'''
...
class ContaBancaria():
    ...
    def __str__(self):
        return f'Titular: [{self.titular}] ---> R$[{self.saldo}]'

    def Transerferencia(self,x):
